#ifndef GL_UTILS_GLTIME_H_
#define GL_UTILS_GLTIME_H_
...
class GlTime {
 public:
   ...
   */
  GlTime(uint64_t time_us = 0);

  /**
   * Constructs a GlTime object containing the current time
   * @returns GlTime object with the current time
   */
  static GlTime now();
